...
const PrivacyScreen = () => {
  ...
  return (
    <div id="container">
      ...
      >
        <p>
          Hack the crisis built the Spread The Queue app as an Open Source app. This SERVICE is
          provided by Hack the crisis at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          If you choose to use our Service, then you agree to the use of information in relation to
          this policy. The Personal Information is used for providing and improving the Service. We
          will not use or share your information with anyone except as described in this Privacy
          Policy.
        </p>
        <p>
          The terms used in this Privacy Policy have the same meanings as in our Terms and
          Conditions, which are accessible at Spread The Queue unless otherwise defined in this
          Privacy Policy.
        </p>
        ...
        <p>
          Whenever you use our Service, in a case of an error in the app we collect data and
